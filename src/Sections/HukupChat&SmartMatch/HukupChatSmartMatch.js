    ...
    <>
      <div className="hukupChat&SmartMatch lg:my-[4rem] my-[2rem]">
        ...
        <div className="relative max-w-[400px] xl:max-w-[1280px] h-[335px] mx-auto md:max-w-[752px] 2xl:max-w-[1200px] md:mx-auto md:h-[450px] lg:mx-auto lg:max-w-[1050px]">
          ...
          {/* text1 */}
          <div
            className="absolute 2xl:left-[7%] lg:text-[13px] 2xl:w-[14%] sm:top-[17%] sm:left-[-21%] sm:w-[37%] sm:text-[11px] top-[11%] lg:left-[7%] font-[700] lg:top-[25%] lg:w-[15%] md:text-[11px] md:top-[20%] md:left-[1%] left-[1%] shadow-[0px_0px_57.7px_25px_rgba(252,114,146,0.3)] 
          ...
          {/* text2 */}
          <div
            className="absolute 2xl:right-[8%] sm:top-[41%] lg:text-[13px] sm:right-[-21%] sm:w-[37%] sm:text-[11px] font-[700] lg:top-[54%] lg:right-[9%] md:right-[0%] lg:w-[15%] md:text-[11px] md:top-[39%] top-[15%] md:w-[20%]  right-[1%] shadow-[0px_0px_57.7px_25px_rgba(252,114,146,0.3)] 
