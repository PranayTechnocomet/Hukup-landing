...
export default function Dashboard() {
  ...
  // const [showSliderBlocker, setShowSliderBlocker] = useState(false);
  ...
  //     // Find the YourPerfectMatch section specifically
  //     const sliderSection = document.querySelector('.your-perfect-match-section');

  //     if (sliderSection && scrollingUp) {
  //       const rect = sliderSection.getBoundingClientRect();

  //       // Check if slider section is visible in viewport
  //       const isSliderVisible = rect.top < window.innerHeight && rect.bottom > 0;

  //       // Only show blocker when scrolling up AND slider is visible
  //       if (isSliderVisible && currentScrollY > 100) {
  //         setShowSliderBlocker(true);
  //       } else {
  //         setShowSliderBlocker(false);
  //       }
  //     } else {
  //       setShowSliderBlocker(false);
  //     }
  ...
  return (
    <>
      ...
      {/* {showSliderBlocker && (
        ...
        >
          <div
            className="dashboard-bg-img-layer"
            style={{
              width: '100%',
              height: '100%',
            }}
