    ...
    <>
      <div className="xl:max-w-[1140px] lg:max-w-[1024px] 2xl:max-w-[1400px] w-[90%] mx-auto">
        ...
        <div className="relative h-[700px] md:h-[630px] lg:h-[740px]">
          ...
          {/* firstbtn */}
          <div className="2xl:left-[6%] xl:left-[6.5%] app-btn absolute w-[48%] top-[-15%] 2xl:w-[14%] xl:w-[15%] xl:top-[-1%] md:top-[-8%] md:w-[22%] lg:w-[20%] lg:top-[-6%] sm:top-[-14%] sm:w-[28%] p-[6px] rounded-[1rem] bg-[linear-gradient(178deg,#FC7292,rgba(238,237,237,0.5))]">
          ...
          {/* second btn */}
          <div className="2xl:left-[6%] xl:left-[6.5%] app-btn play-btn absolute sm:left-0 2xl:top-[9%] 2xl:w-[14%] xl:w-[15%] xl:top-[10%] md:top-[3%] md:w-[22%] lg:w-[20%] sm:top-[-4%] sm:w-[28%] p-[6px] rounded-[1rem] w-[48%] right-[1%] top-[-15%] bg-[linear-gradient(178deg,#FC7292,rgba(238,237,237,0.5))]">
            <div className="bg-[rgba(255,255,255,0.9)] md:py-[7px] rounded-[11px] lg:py-[10px] py-[10px] px-[5px] text-center">
              <div className="flex items-center gap-[4px] sm:gap-3">
                <Image
