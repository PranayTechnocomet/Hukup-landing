    ...
    <div className="xl:mt-[4rem] lg:mt-[-4rem] 2xl:mt-[7rem] xl:mb-25 mb-15 mt-[15%] sm:mt-[6rem] md:mt-[2rem]">
      ...
      <div className="flex  justify-center mt-12 md:mt-15 lg:mt-22 relative max-w-[345px] md:max-w-[768px] lg:max-w-[1070px] mx-auto">
        <Image
          ...
          className="md:w-[370px] mobile-con md:h-[565px] w-[200px] h-[300px]"
        />
        <Image
          src={phoneheart}
          alt="phoneheart"
        ...
        />
        <div className="text-[#FC7292] text-base transition-transform duration-200 hover:scale-105  lg:text-[19px] md:w-[25%] md:text-[20px] md:left-[3%] md:top-[37%] sm:top-[40%] text-[10px] sm:left-[-25%] sm:w-[46%] sm:text-[14px] w-[30%] lg:w-[30%] flex lg:items-center left-[-2%] family-reemkufi absolute top-[37%] lg:left-[9%] font-[800] md:font-[700]">
        ...
        />
        <div className="text-[#FC7292] text-base transition-transform duration-200 hover:scale-105 md:right-[2%] lg:text-[19px] md:w-[33%] md:text-[20px] sm:right-[-36%] sm:w-[65%] sm:text-[14px] flex lg:items-center family-reemkufi font-[800] text-[10px] w-[30%] lg:font-[700] absolute lg:top-[36%] lg:right-[3%] right-[2%]  top-[35%]">
          <span className="text-[30px]">
            <LuDot />
          </span>
        ...
        />
        <div className="text-[#FC7292] text-base transition-transform duration-200 hover:scale-105  lg:text-[19px] md:text-[20px] md:right-[15%] sm:text-[14px] sm:right-[-1%] flex items-center text-[10px] family-reemkufi font-[700] absolute top-[12%] lg:right-[22%] right-[5%]">
          <span className="text-[30px]">
            <LuDot />
          </span>
          Block users.
        ...
        />
        <div className="text-[#FC7292] text-base transition-transform duration-200 hover:scale-105 md:w-[34%] lg:text-[19px] md:left-[2%] md:text-[20px] md:top-[67%] sm:left-[-26%] sm:top-[70%] sm:w-[60%] sm:text-[14px] flex lg:items-center text-[10px]  family-reemkufi font-[800] lg:font-[700] absolute top-[66%] left-[-2%] w-[38%] lg:left-[6%] lg:w-[35%] lg:top-[70%]">
          <span className="text-[30px]">
            <LuDot />
          </span>
        ...
        />
        <div className="text-[#FC7292] text-base transition-transform duration-200 hover:scale-105 lg:text-[19px] sm:w-[65%] md:w-[30%] md:right-[1%] md:text-[20px] sm:bottom-[31%] sm:right-[-38%] sm:text-[14px] flex  family-reemkufi lg:font-[700] absolute text-[9px] bottom-[29%] lg:bottom-[33%] right-[2%] font-[800]  lg:right-[5%]  w-[26%]">
          <span className="text-[30px]">
            <LuDot />
          </span>
